...
Tags: BuddyPress,BuddyPress login,redirect,redirect to profile
Requires at least: BuddyPress 1.2
Tested up to:WordPress 3.5.2+ BuddyPress 1.7.2
Stable tag: 1.2

BP Redirect to Profile is a BuddyPress plugin which redirects a user to their profile on login.
== Description ==
BP Redirect to Profile is a plugin for BuddyPress based site, which enables site admins to redirect users to their profile on login. It's simple and helps to provide a better user experience.
...
Please note, The plugin must be activated sitewide on WordPress Multisite.
...
= Version 1.1 =
Update to remove the deprecated notice
= Version 1.1 =
