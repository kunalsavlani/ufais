	...
	function validate_sumbission() {
		...
		if ($this->navigation == 'layout_settings') {
			...
			$this->fields = array(
				'var' => array(),
				'array' => array(
					'layout' => array('header', 'footer', 'default', 'home', 'page', 'post', 'blog', 'category', 'author', 'tag', 'date', 'search', 'error', 'bp', 'bp-activity', 'bp-blogs', 'bp-forums', 'bp-groups', 'bp-groups-single', 'bp-groups-single-plugins', 'bp-members', 'bp-members-single', 'bp-members-single-plugins', 'bbpress' )
				)
			);
