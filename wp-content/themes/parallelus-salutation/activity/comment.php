...
<li id="acomment-<?php bp_activity_comment_id(); ?>">
	...
	<div class="acomment-meta">
		...
		printf( __( '<a href="%1$s">%2$s</a> <span class="time-since date">%3$s</span>', 'buddypress' ), bp_get_activity_comment_user_link(), bp_get_activity_comment_name(), bp_get_activity_comment_date_recorded() );
		?>
		...
		<?php endif; ?>
		<?php /*?><div class="acomment-options"><?php */?>
