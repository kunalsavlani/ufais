...
?>
	...
	<div class="topics-list-container item-container">
		<table class="bbp-topics" id="bbp-forum-<?php bbp_topic_id(); ?>">
			<thead>
				<tr>
					<th class="bbp-topic-title"><?php _e( 'Topic', 'bbpress' ); ?></th>
					<?php /*?><th class="bbp-topic-voice-count"><?php _e( 'Voices', 'bbpress' ); ?></th>
					...
					<?php if ( ( bbp_is_user_home() && ( bbp_is_favorites() || bbp_is_subscriptions() ) ) ) : ?><th class="bbp-topic-action"><?php _e( 'Remove', 'bbpress' ); ?></th><?php endif; ?><?php */?>
				</tr>
			</thead>
