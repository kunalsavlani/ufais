...
<div id="item-header-avatar">
	<a href="<?php bp_user_link() ?>">
		...
		$avatarURL = bp_theme_avatar_url(128,128,'', bp_core_fetch_avatar(array( 'item_id' => $GLOBALS['bp']->displayed_user->id, 'type' => 'full', 'html' => 'false', 'width' => 128, 'height' => 128 )) );
		echo '<div class="avatar" style="background-image: url(\''.$avatarURL.'\'); width:128px; height:128px; "></div>';  //bp_displayed_user_avatar( 'type=full' ) 
		//echo bp_core_fetch_avatar(array( 'item_id' => $GLOBALS['bp']->displayed_user->id, 'type' => 'full', 'html' => 'false' ));?>
	</a>
</div><!-- #item-header-avatar -->


<div id="item-header-content" class="member-single-header">
	<h1 class="entry-title fn"><a href="<?php bp_user_link() ?>"><?php bp_displayed_user_fullname() ?></a></h1> <span class="highlight">(@<?php bp_displayed_user_username() ?>)</span>
