	...
	<table id="message-threads" class="notice-threads">
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			<tr>
				...
				<td width="1%">
					<a class="button btn small" href="<?php bp_message_activate_deactivate_link() ?>" class="confirm"><span><?php bp_message_activate_deactivate_text() ?></span></a>
				</td>
				<td width="1%">
					<a class="button btn small" href="<?php bp_message_notice_delete_link() ?>" class="confirm" title="<?php _e( "Delete Message", "buddypress" ); ?>"><span><?php _e( "Delete", "buddypress" ); ?></span></a>
				</td>
			</tr>
		<?php endwhile; ?>
