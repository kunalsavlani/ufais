		...
		<li>
			<div class="item-avatar">
				<a href="<?php bp_blog_permalink() ?>"><?php 
					...
					$avatar = apply_filters( 'bp_get_blog_avatar_' . $GLOBALS['blogs_template']->blog->blog_id, bp_core_fetch_avatar( array( 'item_id' => $GLOBALS['blogs_template']->blog->admin_user_id, 'email' => $GLOBALS['blogs_template']->blog->admin_user_email, 'type' => 'full', 'html' => 'false', 'width' => 80, 'height' => 80 ) ) );
					$blogAvatar = apply_filters( 'bp_get_blog_avatar', $avatar, $GLOBALS['blogs_template']->blog->blog_id, array( 'item_id' => $GLOBALS['blogs_template']->blog->admin_user_id, 'email' => $GLOBALS['blogs_template']->blog->admin_user_email, 'type' => 'full', 'html' => 'false', 'width' => 80, 'height' => 80 ) );
					
					// get the avatar image
					$avatarURL = bp_theme_avatar_url(80,80,'',$blogAvatar );
