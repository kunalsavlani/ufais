...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					...
					<div class="columns block three_fourths_column last clearfix">		
						...
						<form class="product_form row" enctype="multipart/form-data" action="<?php echo wpsc_this_page_url(); ?>" method="post" name="1" id="product_<?php echo wpsc_the_product_id(); ?>">
