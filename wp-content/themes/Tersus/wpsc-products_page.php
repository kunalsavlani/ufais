...
<?php // */ ?>
	...
	<?php if(wpsc_display_products()): ?>
		...
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			...
			<div class="default_product_display row product_view_<?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?> group">     
				<?php if(wpsc_show_thumbnails()) :?>
					<div class="columns block four_column" id="imagecol_<?php echo wpsc_the_product_id(); ?>">
                    	...
                    	echo do_shortcode('[imageeffect type="'.$image_effect.'" height="'.$image_height.'" alt="'.$title.'" '.$NV_lightbox.' url="'. wpsc_the_product_image($image_width, $image_height).'" ]');  ?>
                    		
						<?php else: ?> 
                        
							<?php echo do_shortcode('[imageeffect type="'.$image_effect.'" height="'.$image_height.'" alt="'.$title.'" url="'. WPSC_CORE_THEME_URL .'wpsc-images/noimage.png" ]');  ?>
				...
				<?php endif; ?>
					<div class="columns block three_fourths_column last clearfix">
						...
						<?php endif; ?>					
						<form class="product_form row"  enctype="multipart/form-data" action="<?php echo $action; ?>" method="post" name="product_<?php echo wpsc_the_product_id(); ?>" id="product_<?php echo wpsc_the_product_id(); ?>" >
