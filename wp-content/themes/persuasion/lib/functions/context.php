...
function mysite_body_class( $class = array() ) {
	...
	if( is_singular() ) {
		...
		if( $template == 'template-featuretour.php' || $template == 'template-squeeze-page.php' || strpos( $dependencies, 'fancy_portfolio' ) !== false || apply_atomic( 'fancy_portfolio', false ) == true )
			$classes[] = 'full_width';
